...
public class PadalaConfirmation extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // Set the content view to your user_profile.xml layout file
        setContentView(R.layout.padala_confirmation);
        ...
        backButton.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(PadalaConfirmation.this, PadalaSecondPage.class);
        ...
        confirmBooking.setOnClickListener(v -> {
            // Navigate to the welcome page
            Intent intent = new Intent(PadalaConfirmation.this, PadalaArriving.class);
            startActivity(intent);
